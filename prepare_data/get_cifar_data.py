...
np.save("cifar10/train_images.npy", train_images)
np.save("cifar10/train_labels.npy", train_labels)
np.save("cifar10/test_images.npy", test_images)
np.save("cifar10/test_labels.npy", test_labels)